...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post workouts_url, params: { workout: { description: @workout.description, title: @workout.title } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { description: @workout.description, title: @workout.title } }
